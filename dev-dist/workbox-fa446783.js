define(['exports'], function (t) {
  ...
  class o {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let o = r && r.handler;
      const c = t.method;
      if ((!o && this.i.has(c) && (o = this.i.get(c)), !o)) {
        return;
      }
      let a;
      try {
  ...
  class b {
    ...
    async cacheMatch(t) {
      ...
      for (const t of this.iterateCallbacks('cachedResponseWillBeUsed')) {
        s =
          (await t({ cacheName: n, matchOptions: i, cachedResponse: s, request: r, event: this.event })) ||
          void 0;
      }
      return s;
    }
    async cachePut(t, e) {
      ...
      for (const t of this.iterateCallbacks('cacheDidUpdate')) {
        await t({ cacheName: a, oldResponse: f, newResponse: c.clone(), request: r, event: this.event });
      }
      return !0;
    }
  ...
  class C {
    ...
    async L(t, e, s, n) {
      ...
      if (
        (await e.runCallbacks('handlerDidComplete', { event: n, request: s, response: i, error: r }),
        e.destroy(),
        r)
      ) {
        throw r;
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if (this.K.has(i) && this.K.get(i) !== t) {
          throw new s('add-to-cache-list-conflicting-entries', { firstEntry: this.K.get(i), secondEntry: t });
        }
