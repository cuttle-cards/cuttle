    ...
    <v-container>
      ...
      <v-row class="d-flex flex-column mb-4">
        ...
        <p class="mb-4">
          ...
          <a href="https://www.cuttle.cards"> www.cuttle.cards</a>, however Cuttle can be played
          with 2-4 players. 3 and 4-player Cuttle each have slight variations on the rules to
          optimize the game balance while changing the pace and the feel. Give them a try next time
          you're playing Cuttle in a group!
        </p>
        <h3>3 Player Cuttle: Cutthroat</h3>
        <p class="mb-4">
          Cutthroat is a brutally fast-paced 1v1v1 version of Cuttle, full of betrayal and pivotal
          moments!
        </p>
        ...
        <p>
          The rules are otherwise the same as 1v1 Cuttle, with play proceeding clockwise from the
          left of the dealer, with the following other changes:
        </p>
        <ul>
          <li>
