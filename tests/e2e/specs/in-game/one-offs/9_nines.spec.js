  ...
  describe('Player Playing NINES', () => {
    ...
    it('Plays a 9 on a triple jack to steal back jacked point card', () => {
      ...
      assertGameState(0, {
        ...
        p1Points: [ Card.ACE_OF_SPADES ],
        p1FaceCards: [],
        scrap: [ Card.ACE_OF_CLUBS, Card.TWO_OF_CLUBS, Card.THREE_OF_CLUBS, Card.FOUR_OF_CLUBS,
          Card.FIVE_OF_CLUBS, Card.SIX_OF_CLUBS, Card.SEVEN_OF_CLUBS, Card.EIGHT_OF_CLUBS, Card.TEN_OF_CLUBS,
          ...
          Card.FOUR_OF_HEARTS, Card.FIVE_OF_HEARTS, Card.SIX_OF_HEARTS, Card.SEVEN_OF_HEARTS, Card.EIGHT_OF_HEARTS,
          Card.TEN_OF_HEARTS, Card.JACK_OF_HEARTS, Card.QUEEN_OF_HEARTS, Card.KING_OF_HEARTS, Card.TWO_OF_SPADES,
          Card.THREE_OF_SPADES, Card.FOUR_OF_SPADES, Card.FIVE_OF_SPADES, Card.SIX_OF_SPADES, Card.SEVEN_OF_SPADES,
          Card.EIGHT_OF_SPADES, Card.NINE_OF_SPADES, Card.QUEEN_OF_SPADES, Card.KING_OF_SPADES ]
      });
    ...
    it('Plays a 9 on a point card that has been triple jacked', () => {
      ...
      assertGameState(0, {
        ...
        p1Points: [],
        p1FaceCards: [],
        scrap: [ Card.ACE_OF_CLUBS, Card.TWO_OF_CLUBS, Card.THREE_OF_CLUBS, Card.FOUR_OF_CLUBS, Card.FIVE_OF_CLUBS,
          ...
          Card.EIGHT_OF_HEARTS, Card.TEN_OF_HEARTS, Card.JACK_OF_HEARTS, Card.QUEEN_OF_HEARTS, Card.KING_OF_HEARTS,
          Card.TWO_OF_SPADES, Card.THREE_OF_SPADES, Card.FOUR_OF_SPADES, Card.FIVE_OF_SPADES, Card.SIX_OF_SPADES,
          Card.SEVEN_OF_SPADES, Card.EIGHT_OF_SPADES, Card.NINE_OF_SPADES, Card.JACK_OF_SPADES, Card.QUEEN_OF_SPADES,
          Card.KING_OF_SPADES ]
      });
    });
