...
const gameState = {
  ...
  deck: [ Card.SEVEN_OF_CLUBS, Card.ACE_OF_HEARTS,
...
const resolveFiveMoveBodies = [
  { moveType: MoveType.RESOLVE_FIVE, playedBy: 0, cardId: null, isValid: true },
];
...
export const resolvingFivePhase3HasNoCardsInHand = {
  name: 'resolvingFivePhase3: Player has no cards in hand',
  gameState,
  playedBy: 0,
  moveBodiesByType: [
