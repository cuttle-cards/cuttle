...
const gameState = {
  p0: {
    ...
    faceCards: [ Card.KING_OF_SPADES, Card.QUEEN_OF_DIAMONDS ],
  },
  p1: {
    hand: [
      Card.TWO_OF_CLUBS,
...
const validMoveBodies = [
  ...resolveMoveBodies,
  // Note countering is not legal
];

export const counteringPhase2CannotCounter = {
  name: 'counteringPhase2: Cannot counter',
  gameState,
  playedBy: 1,
  moveBodiesByType: [
