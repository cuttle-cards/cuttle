...
const gameState = {
  ...
  deck: [ 
    Card.KING_OF_DIAMONDS, Card.THREE_OF_CLUBS,
    Card.TWO_OF_CLUBS, Card.JACK_OF_DIAMONDS,
    Card.SEVEN_OF_CLUBS,
    Card.FOUR_OF_CLUBS, Card.FIVE_OF_CLUBS,
...
const sevenPointsMoveBodies = [
  { moveType: MoveType.SEVEN_POINTS, playedBy: 0, cardId: '3C', isValid: true },
];

const sevenScuttleMoveBodies = [
  { moveType: MoveType.SEVEN_SCUTTLE, playedBy: 0, cardId: '3C', targetId: 'TH', isValid: false },
  { moveType: MoveType.SEVEN_SCUTTLE, playedBy: 0, cardId: '3C', targetId: 'AC', isValid: true },
];

const sevenFaceCardMoveBodies = [ { moveType: MoveType.SEVEN_FACE_CARD, playedBy: 0, cardId: 'KD', isValid: true }, ];
...
const sevenOneOffMoveBodies = [
  { moveType: MoveType.SEVEN_ONE_OFF, playedBy: 0, cardId: '3C', isValid: true },
];
...
export const resolvingSevenPhase2 = {
  name: 'resolvingSevenPhase 2',
  gameState,
  moveBodiesByType: [
