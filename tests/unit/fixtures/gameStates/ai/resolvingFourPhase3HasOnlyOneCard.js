...
const resolveFourMoveBodies = [
  { moveType: MoveType.RESOLVE_FOUR, playedBy: 1, cardId1: 'QD', isValid: true },
];
...
export const resolvingFourPhase3HasOnlyOneCard = {
  name: 'resolvingFourPhase3: user has only one card',
  gameState,
  playedBy: 1,
  moveBodiesByType: [
