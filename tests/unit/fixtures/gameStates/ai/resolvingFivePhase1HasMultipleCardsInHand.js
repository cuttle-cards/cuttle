...
const resolveFiveMoveBodies = [
  ...
  { moveType: MoveType.RESOLVE_FIVE, playedBy: 0, cardId: 'AD', isValid: true },
  { moveType: MoveType.RESOLVE_FIVE, playedBy: 0, cardId: '7S', isValid: true },
  { moveType: MoveType.RESOLVE_FIVE, playedBy: 0, cardId: '4H', isValid: true },
];
...
export const resolvingFivePhase1HasMultipleCardsInHand = {
  name: 'resolvingFivePhase1: Player has multiple cards in hand',
  gameState,
  playedBy: 0,
  moveBodiesByType: [
