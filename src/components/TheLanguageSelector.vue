<template>
  <v-menu location="end">
    ...
    <v-list data-cy="lang-list" density="compact" class="bg-surface-light text-surface-dark">
      <v-list-item
...
const activatorClass = computed(() => props.variant === 'dark' ? `bg-surface-light text-surface-dark` : '');
