<template>
  <v-menu location="end">
    ...
    <v-list data-cy="lang-list" density="compact" class="bg-game-card text-game-board">
      <v-list-item
...
const activatorClass = computed(() => props.variant === 'dark' ? `bg-game-card text-game-board` : '');
