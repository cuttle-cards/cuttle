  ...
  <BaseDialog id="rulesDialog" max-width="1250">
    ...
    <template #body>
      ...
      <section>
        <h3>Goal</h3>
        <p>
          The goal is to be the first player to have 21 <strong>or more</strong> points. When a player has 21
          or more points, they win immediately and the game is over.
        </p>
      </section>
      <section>
        <h3>Setting Up</h3>
      ...
      <section>
        ...
        <h4>1. Draw</h4>
        <p>
          You may draw one card from the deck and put it in your hand. If the deck is empty, you may pass. If
          three consecutive turns end with a pass, the game is a draw.
        </p>
        * Click the deck to draw a card

        <h4>2. Points</h4>
        <p>
          You may play any number card, Ace-Ten for the number of points shown on the card (Ace is one point).
          The first player to have 21 <strong>or more</strong> points wins.
        </p>
        ...
        * To play a card as a <strong>One-Off</strong>, click a card in your hand to select it, then click the
        Scrap Pile or an opponent's card to target.
      </section>
      ...
      <section>
        ...
        <p>
          ...
          (revealed to you). Unlike One-Offs, Glasses Eights remain in play until destroyed. * When playing an
          eight to your field, you will be prompted to choose to play it for Glasses or Points.
        </p>
        <p>
          <strong>Jack:</strong> Play a jack on top of a Point Card to move it to your side of the board. You
          keep control of the point card as long as you control the top jack.
        </p>
        <p>
          ...
          <strong>including countering</strong>), 9's and Jacks. Note that Queens do not protect against Scuttling.
        </p>
        <p>
          <strong>King:</strong> While you have a King, the minimum points needed to win is reduced. Each
          additional King further reduces the limit. If you manage to get all 4 kings on the field, you are a
          hero and win immediately.
        </p>
        <div>
          <ol>
