<template>
  <div :class="[ isInModal ? 'bg-base-dark text-base-light' : 'pa-4 bg-base-dark text-base-light' ]">
    <v-container>
      ...
      <v-row>
        ...
        <v-col>
          ...
          <section>
            ...
            >
              <h1 class="text-h2 text-base-light section-title">
          ...
          <section v-if="!isInModal" class="section">
            <v-row class="bg-base-light pa-8 rounded-xl d-flex flex-column align-center">
              <h2 class="text-base-dark pa-8">
          ...
          <section class="section">
            ...
            <v-row>
              ...
              <v-list class="mt-4 rounded-xl w-100 my-8" bg-color="base-dark" base-color="base-light">
                <v-list-item>
                  <v-chip
                    variant="flat"
                    class="mr-2 mb-1"
