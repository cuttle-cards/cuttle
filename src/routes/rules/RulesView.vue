<template>
  <div :class="[ isInModal ? 'bg-surface-dark text-surface-light' : 'pa-4 bg-surface-dark text-surface-light' ]">
    <v-container>
      ...
      <v-row>
        ...
        <v-col>
          ...
          <section>
            ...
            >
              <h1 class="text-h2 text-surface-light section-title">
          ...
          <section v-if="!isInModal" class="section">
            <v-row class="bg-surface-light pa-8 rounded-xl d-flex flex-column align-center">
              <h2 class="text-surface-dark pa-8">
          ...
          <section class="section">
            ...
            <v-row>
              ...
              <v-list class="mt-4 rounded-xl w-100 my-8" bg-color="surface-dark" base-color="surface-light">
                <v-list-item>
                  <v-chip
                    variant="flat"
                    class="mr-2 mb-1"
